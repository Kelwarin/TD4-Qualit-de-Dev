...
public class TestToy {
    public static void main(String[] args) {
        ...
        try {
            String line;
            String car;
            FileInputStream file = new FileInputStream("ecommerceProxyEtud/data/toy.txt");
        ...
        try {
            String line;
            String car;
            FileInputStream file = new FileInputStream("ecommerceProxyEtud/data/toymotifs.txt");
            Scanner scanner = new Scanner(file);
            while (scanner.hasNextLine()) {
                line = scanner.nextLine();
                Scanner sc = new Scanner(line);
